...
for (i = 0; i < list.length; i += 6) {
    ...
    run("Merge Channels...", "c1=" + channelName1 + " c2=" + channelName2 + " c3=" + channelName3 + " c4=" + channelName4 + " c5=" + channelName5 + " c6=" + channelName6 + " create");

    // Save the merged image in the output directory
    saveAs("Tiff", output + "merged_" + i/6);
